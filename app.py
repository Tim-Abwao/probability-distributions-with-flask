...
import pandas as pd
from handy_functions import (get_random_sample, get_graphs, descriptive_stats,
...
def parameters():
    if request.method == 'POST':
        ...
        learn_more = distribution_data.at[chosen_distr, 'wiki_link']
        ...
        return render_template('index.html', chosen_distr=chosen_distr,
                               ...
                               param_info=param_info,  learn_more=learn_more,
                               distributions=distribution_names,
                               dist_summary=dist_summary, input_form=True)
...
def selection():
    if request.method == 'POST':
        ...
        return render_template('index.html', chosen_distr=chosen_distr,
                               ...
                               summary_stats=summary_stats, graphs=graphs,
